...
function setLinks(data) {
    ...
    for(let i in data) {
        ...
        `
        <li><a href="./servidores.html" onclick="getCurrentServer(${data[i].idServidor})" class="nav-link text-left options-menu" role="button"><i class="bi bi-hdd"></i>${data[i].modelo}</a></li>
        `
    }
};